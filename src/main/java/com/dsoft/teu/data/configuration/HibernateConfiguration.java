package com.dsoft.teu.data.configuration;
...
@ComponentScan({"com.dsoft.teu.data.configuration"})
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.dsoft.teu.data.model" });
